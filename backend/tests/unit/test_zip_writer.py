...
def test_build_srt_zip():
    task1 = Task(status="completed", file_name="first_file.srt", source_path="day1/first_file.srt", result=[{"start": 0.0, "end": 2.0, "text": "Test one"}])
    task2 = Task(status="completed", file_name="second_file.srt", source_path="day2/second_file.srt", result=[{"start": 1.0, "end": 3.0, "text": "Test two"}])
